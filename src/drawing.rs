...
impl Text {
    ...
    pub fn get_alignment(&self, ) -> CallHandle<crate::ui::TextAlignment> {
        let mut proc_call = krpc::ProcedureCall::new();
        proc_call.set_service(String::from("Drawing"));
    ...
    pub fn get_anchor(&self, ) -> CallHandle<crate::ui::TextAnchor> {
        let mut proc_call = krpc::ProcedureCall::new();
        proc_call.set_service(String::from("Drawing"));
    ...
    pub fn get_style(&self, ) -> CallHandle<crate::ui::FontStyle> {
        let mut proc_call = krpc::ProcedureCall::new();
        proc_call.set_service(String::from("Drawing"));
    ...
    /// <doc> <summary> Alignment. </summary> </doc>
    pub fn set_alignment(&self, p_value: crate::ui::TextAlignment) -> CallHandle<()> {
        let mut proc_call = krpc::ProcedureCall::new();
        proc_call.set_service(String::from("Drawing"));
    ...
    /// <doc> <summary> Anchor. </summary> </doc>
    pub fn set_anchor(&self, p_value: crate::ui::TextAnchor) -> CallHandle<()> {
        let mut proc_call = krpc::ProcedureCall::new();
        proc_call.set_service(String::from("Drawing"));
    ...
    /// <doc> <summary> Font style. </summary> </doc>
    pub fn set_style(&self, p_value: crate::ui::FontStyle) -> CallHandle<()> {
        let mut proc_call = krpc::ProcedureCall::new();
        proc_call.set_service(String::from("Drawing"));
